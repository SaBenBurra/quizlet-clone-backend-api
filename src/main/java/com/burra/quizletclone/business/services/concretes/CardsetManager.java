...
public class CardsetManager implements CardsetService {
  ...
  public DataResult<ArrayList<CardsetGetAllResponse>> getAll() {
    ArrayList<Cardset> cardsets =
        (ArrayList<Cardset>)cardsetRepository.findAllByOrderByIdDesc();
    ArrayList<CardsetGetAllResponse> response =
        new ArrayList<CardsetGetAllResponse>();
  ...
  public DataResult<CardsetGetByIdResponse> getById(int cardsetId) {
    ...
    CardsetGetByIdResponse response =
        CardsetGetByIdResponse.FromEntity(cardset);
    return new SuccessDataResult<CardsetGetByIdResponse>(response);
  }

  @Override
  public DataResult<CardsetCreateResponse>
  create(CardsetCreateRequest request) {
  ...
  @Override
  @Transactional
  public DataResult<CardsetUpdateResponse> update(CardsetUpdateRequest request,
                                                  int cardsetId) {
    ...
    ArrayList<CardCreateRequest> newCardsData =
        (ArrayList<CardCreateRequest>)request.getCards();
    ...
    CardsetUpdateResponse response =
        CardsetUpdateResponse.FromEntity(updatedCardset);
